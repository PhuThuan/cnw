...
foreach ($select_product as $row) {
   ...
   ?>
<div class="col-lg-3 spham produkt_gruppe_div" data-money="<?php echo $gia; ?>"
    data-brand_name="<?php echo $row['loai']; ?>">

    <img src="img/sanpham/<?php echo $row['image1']; ?>" alt="" class="d-block w-100 mx-auto hinh"
        onmouseover="this.src='img/sanpham/<?php echo $row['image2']; ?>';"
        onmouseout="this.src='img/sanpham/<?php echo $row['image1']; ?>';" />
